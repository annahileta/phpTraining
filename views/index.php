				...
				<div id="content">
					...
					<div class="post">
						...
						<p class="meta">Posted by <a href="#"><?php echo $newsItem['author_name'];?></a> on <?php echo $newsItem['date'];?>
							&nbsp;&bull;&nbsp; <a href='my_php_codes/mvc_framework/index.php/news/<?php echo $newsItem['id'] ;?>' class="permalink"> Full article</a></p>
						<div class="entry">
							<p><img src="/my_php_codes/mvc_framework/templates/images/pic01.jpg" width="800" height="300" alt="" /></p>
